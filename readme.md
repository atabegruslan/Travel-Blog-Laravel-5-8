...
1. Pass access token (`auth('api')->login($currentUser)`) from backend to view template, like https://github.com/atabegruslan/Travel-Blog-Laravel-5-8/blob/master/app/Http/Controllers/Controller.php
